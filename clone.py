...
#                 if url:
#                     # Ensure URL is valid and resolved
#                     full_url = urljoin(base_url, url)
#                     print(f"Found URL: {full_url}")  # Debug statement
#                     # Save the URL to the modified HTML
...
def clone_site():
    website_url = request.form['url']
    print(f"Cloning website: {website_url}")  # Debug statement
    clone_website(website_url, app.config['CLONE_FOLDER'])
    return redirect(url_for('serve_cloned_site'))
